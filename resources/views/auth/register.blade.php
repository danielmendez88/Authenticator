                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                            <label for="lasta_name" class="col-md-4 control-label">Apellidos</label>

                            <div class="col-md-6">
                                <input id="lasta_name" type="text" placeholder="Apellidos" class="form-control"  name="last_name"  value="{{ old('last_name') }}">
